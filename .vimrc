...
" Quickfix
nnoremap <leader>x :call Quickfix()<cr>
...
nnoremap <leader>d :NERDTreeClose<cr>:NERDTreeFind<cr>
...
nnoremap <leader>i :lopen<CR>
nnoremap <leader>o :lclose<CR>
